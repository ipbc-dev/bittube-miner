...
bool minethd::self_test()
{
	...
	else if(::jconf::inst()->GetCurrentCoinSelection().GetDescription(1).GetMiningAlgo() == cryptonight_bittube2)
	{
		...
		hashf("\x38\x27\x4c\x97\xc4\x5a\x17\x2c\xfc\x97\x67\x98\x70\x42\x2e\x3a\x1a\xb0\x78\x49\x60\xc6\x05\x14\xd8\x16\x27\x14\x15\xc3\x06\xee\x3a\x3e\xd1\xa7\x7e\x31\xf6\xa8\x85\xc3\xcb", 43, out, ctx[0]);
		bResult = bResult && memcmp(out, "\x11\x51\x89\x7d\xc1\x6a\xf4\x64\x50\xb0\x9b\x87\x86\xc9\xe4\xf5\xf8\x7d\x5a\x7b\xd7\x33\xe7\xe7\x1d\x64\x11\xf2\x48\xa6\xf4\xe7", 32) == 0;
	}
	for (int i = 0; i < MAX_N; i++)
