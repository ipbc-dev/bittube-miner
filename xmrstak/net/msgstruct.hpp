...
struct job_result
{
	...
	job_result() {}
	job_result(const char* sJobID, uint32_t iNonce, const uint8_t* bResult, uint32_t iThreadId, xmrstak_algo algo) : iNonce(iNonce), iThreadId(iThreadId), algorithm(algo)
	{
