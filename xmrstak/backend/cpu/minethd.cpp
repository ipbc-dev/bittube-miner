...
bool minethd::self_test()
{
	...
	else if (::jconf::inst()->GetMiningAlgo() == cryptonight_ipbc)
	{
		...
		bResult = memcmp(out, "\x8f\xd2\x87\x05\x1a\x60\x18\xcd\xf1\x11\x5a\xa0\xa6\xe2\x44\x86\x33\x97\xea\x31\x89\x59\x34\x60\x60\x75\xda\xb3\xca\x73\x6a\x24", 32) == 0;
	}
